...
function QiniuJsSDK() {
    ...
    this.uploader = function(op) {
        console.log("qiniu.uploader" + JSON.stringify(op));
        if (!op.domain) {
        ...
        var reset_chunk_size = function() {
            ...
            console.log("reset_chunk_size" + op.chunk_size);
        };
        reset_chunk_size();

        var getUpToken = function() {
            console.log("getUpToken" + that.token);
            if (!op.uptoken) {
        ...
        console.log("newuploader" + JSON.stringify(option) + JSON.stringify(op));
